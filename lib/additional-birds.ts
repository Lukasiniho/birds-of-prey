...
export const additionalBirds: AdditionalBird[] = [
  ...catalogAdditions,
  {
    ...
    prey: [3, 4],
    diet: 'Vor allem Fische; außerdem Wasservögel, kleine Säugetiere und Aas.',
  ...
  },
  {
    ...
    prey: [3, 4],
    diet: 'Vor allem große Fische, besonders Lachse; außerdem Wasservögel, Säugetiere und Aas.',
  ...
  },
  {
    ...
    prey: [2, 5],
    diet: 'Aas ist eine wichtige Nahrungsquelle. Er jagt außerdem kleine Wirbeltiere, besonders Schlangen, sowie Säugetiere und Vögel, darunter Tauben; gelegentlich frisst er auch Insekten oder Fische.',
    source:
  ...
  },
  {
    ...
    prey: [1, 5],
    diet: 'Vor allem Nagetiere und Kaninchen; außerdem Vögel, Reptilien, Insekten und gelegentlich Aas.',
  ...
  },
  {
    ...
    prey: [0, 1, 2],
    diet: 'Vor allem Säugetiere bis Hasengröße und Vögel; gelegentlich weitere kleine Wirbeltiere.',
    source:
  ...
  },
  {
    ...
    prey: [3, 0, 5],
    diet: 'Fische, Aas und kleine Wirbeltiere; auch größere Insekten und andere leicht erreichbare Nahrung.',
    source:
  ...
  },
  {
    ...
    prey: [0, 1, 5],
    diet: 'Kleine Säugetiere, Vögel und Aas; außerdem Insekten und weitere leicht erreichbare Nahrung.',
  ...
  },
  {
    ...
    prey: [4],
    diet: 'Vor allem Schneehühner, dazu andere Vögel wie Enten und gelegentlich Säugetiere.',
  ...
  },
  {
    ...
    prey: [2, 0],
    diet: 'Je nach Region vor allem Ziesel und andere kleine Säugetiere oder Vögel, darunter Tauben.',
  ...
  },
  {
    ...
    prey: [2, 4],
    diet: 'Überwiegend kleine bis mittelgroße Vögel, etwa Tauben; zusätzlich kleine Säugetiere, Reptilien und Insekten.',
  ...
  },
  {
    ...
    prey: [5, 8],
    diet: 'Große Fluginsekten, besonders Libellen, sowie kleine Vögel wie Schwalben und Lerchen.',
  ...
  },
  {
    ...
    prey: [],
    diet: 'Der Falklandkarakara nutzt Seevögel, ihre Eier und Nestlinge sowie Aas. Auch Wirbellose sind wichtig, und das Nahrungsangebot verändert sich deutlich mit der Jahreszeit.',
    source:
  ...
  },
  {
    ...
    prey: [],
    diet: 'Der Schopfkarakara ist ein vielseitiger Nahrungssucher, bei dem Aas häufig eine große Rolle spielt. Er erbeutet außerdem Insekten und verschiedene kleine Wirbeltiere.',
  ...
  },
  {
    ...
    prey: [],
    diet: 'Der Königsbussard lebt hauptsächlich von kleinen Säugetieren der offenen Grasländer. Im Westen sind Hasen und Kaninchen besonders wichtig, östlich der Rocky Mountains häufig Ziesel und Präriehunde.',
  ...
  },
  {
    ...
    prey: [],
    diet: 'Vor allem Faultiere und Affen; daneben weitere Säugetiere, große Vögel und Reptilien.',
    source:
  ...
  },
  {
    ...
    prey: [],
    diet: 'Mittelgroße Säugetiere, größere Vögel und Warane; Zusammensetzung je nach Region und Geschlecht verschieden.',
    source:
  ...
  },
  {
    ...
    prey: [0, 1, 2],
    diet: 'Der Virginia-Uhu jagt vor allem Säugetiere wie Kaninchen, Hasen und Mäuse sowie Vögel. Andere Tiergruppen und gelegentlich Aas erweitern sein großes Nahrungsspektrum.',
  ...
  },
  {
    ...
    prey: [0, 5, 3],
    diet: 'Der Weißstorch sammelt kleine Säugetiere, Amphibien, große Insekten und Regenwürmer in Wiesen und flachem Wasser. Daneben nimmt er Reptilien, Fische, gelegentlich Jungvögel und Aas.',
    source:
  ...
  },
  {
    ...
    prey: [8],
    diet: 'Der Sperber ist auf kleine Vögel spezialisiert. Kleine Nagetiere spielen nur ausnahmsweise eine Rolle.',
