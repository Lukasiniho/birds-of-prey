  ...
  return (
    <Tooltip open={open} onOpenChange={setOpen}>
      <TooltipTrigger
        ...
        className="cursor-help rounded-(--radius-small) border-0 bg-transparent p-0 text-right text-inherit underline decoration-dotted decoration-muted-foreground/50 underline-offset-4 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ring"
