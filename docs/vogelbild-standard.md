...
- Darstellungsrahmen auf der Artseite: Der Rahmen steckt seit dem 14. September in der Bilddatei, nicht im Code. `BirdArt` (`app/raptor-app.tsx`) zeigt jede Art in derselben Box ohne artspezifische Prozentwerte; die früheren Werte (Habichtsadler 87,22 %, Zwergadler 88,35 %, Iberienadler 85,36 % und die übrigen 23) sind als transparenter Rand beziehungsweise als Zuschnitt der Leinwand in die PNGs übernommen. Alle Alter und Morphen einer Art teilen weiterhin denselben Rahmen, also auch denselben Zuschnitt. Zwei Arten passten nicht vollständig hinein, weil ihre Flügelspitzen sonst die Leinwand berührt hätten: Rotschwanzbussard steht bei 104,05 % statt 114,48 %, Riesenseeadler bei 104,08 % statt 108,16 %; beide brauchen ein neu gezeichnetes Original, wenn sie wieder größer stehen sollen. `tests/image-framing.test.mjs` hält den Zustand fest.
...
- Größenkorrekturen einzelner Porträts (unter anderem Bartgeier, Schwarzmilan, Aguja, Kronenadler) stecken im Zuschnitt der Bilddatei. `app/species-row.css` kennt nur die gemeinsamen 64/48 px und keine Art beim Namen.
- Baumfalke-Porträt am 14. September um 90 px nach unten gerückt: Der Kopf saß 7,7 % über der Bildmitte, auf der alle anderen Porträts sitzen. Nur die Position, nicht die Größe.
